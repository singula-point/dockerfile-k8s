...
2、运行cadvisor镜像
docker runit -v /:/rootfs:ro -v /var/run:/var/run:rw -v /sys:/sys:ro -v /var/lib/docker/:/var/lib/docker:ro -e  LOCAL_ADDR=xxxx -e  PUSH_ADDR=xxxx:9091 singula/cadvisor
